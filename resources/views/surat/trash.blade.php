                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <small class="text-muted">
                                                    ...
                                                    <span style="font-size: 10px;">{{ $item->deleted_at->format('H:i') }}
                                                        WIB</span>
                                                </small>
                                            </td>
                                            <td class="text-center px-4">
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    {{-- Tombol Pulihkan --}}
                                                    <form action="{{ route('admin.surat.restore', $item->id) }}"
                                                    ...
                                                    <form action="{{ route('admin.surat.force_delete', $item->id) }}"
                                                        method="POST" class="m-0">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-sm btn-danger px-3 rounded-pill"
                                                            onclick="return confirm('PERINGATAN: Data akan dihapus selamanya. Lanjutkan?')">
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-5">
                                                <img src="https://illustrations.popsy.co/gray/empty-folder.svg"
                                                    alt="Kosong" width="150" class="mb-3">
